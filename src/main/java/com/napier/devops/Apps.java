...
public class Apps
{
    public static void main(String[] args)
    {
        ...
        System.out.println("Getting the top N (10) populated countries in a continent (Asia) where N is provided by the user.");
        ...
        System.out.println();
        System.out.println("Getting all the countries in a continent (Asia) organised by largest population to smallest");
        ...
        System.out.println();
        System.out.println("Getting All Countries In a Region (Caribbean)");
        ...
        System.out.println();
        System.out.println("Getting the top N (10) populated countries in a region (Caribbean) where N is provided by the user.");
        ...
        System.out.println();
        System.out.println("Get the top N (10) populated countries in the world where N is provided by the user.");
        ...
        System.out.println();
        System.out.println("Get all the countries in the world organised by largest population to smallest");
